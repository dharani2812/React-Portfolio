...
import devAnimation from '../../assets/images/logo.json'
import {
  faLinkedin,
  faGithub,
  faInstagram,
  ...
  return (
    <div className="nav-bar">
      <Link className="logo" to="/" onClick={() => setShowNav(false)}>
        <Lottie animationData={devAnimation} loop={true} className="lottie-logo" />
      </Link>
      ...
      <nav className={showNav ? 'mobile-show' : ''}>
        ...
        <NavLink activeclassname="active" className="tools-link" to="/tools" onClick={() => setShowNav(false)}>
      ...
      <ul>
        <li>
          <a href="https://www.linkedin.com/in/dharani-dharan-134b702a1/" target="_blank" rel="noreferrer">
            <FontAwesomeIcon icon={faLinkedin} color="#4d4d4e" className="anchor-icon" />
          </a>
        </li>
        <li>
          <a href="https://github.com/dharani2812" target="_blank" rel="noreferrer">
            <FontAwesomeIcon icon={faGithub} color="#4d4d4e" className="anchor-icon" />
          </a>
        </li>
        <li>
          <a href="https://www.instagram.com/ft_dharani/" rel="noreferrer" target="_blank">
